...
const textArray = [
    `Bitcoin is an open-source, decentralised peer-to-peer financial network, created with a hard limit of 21 million bitcoin, that began on January 3, 2009.`,
    ...
    `The cycle of financial recklessness and taxpayer funded bailouts happens roughly every ten years, and there seems to be no end in sight. <br><br>On October 31st, 2008, a short 9 page whitepaper called “Bitcoin: A Peer-to-Peer Electronic Cash System” was published by an anonymous account who was clearly a genius in mathematics, coding and cryptography, “Satoshi Nakamoto”.`,
    ...
    `Whilst it's a young technology exhibiting growing pains, and still has volatility and potential risks, Bitcoin holds true promise and a credible, digital, open-source alternative to the fiat standard of money.`,
                ]
    ;
